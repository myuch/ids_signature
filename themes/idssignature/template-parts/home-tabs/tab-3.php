...
<div id="tab3" class="slide">
  <div class="slider_bg">
    ...
    <div class="container">
      <h2 class="anim_it_head">Our Signature Moves</h2>
      <p class="anim_it">As part of your design team, IDS Signature specializes in inventive solutions that draw a crowd.</p>
